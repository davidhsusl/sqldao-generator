...
class CriterionBuilder:
    ...
    def equals_filter(self):
        criterion = self.entity_attr.equals_filters(self.condition_attr)
    ...
    def in_filter(self):
        criterion = self.entity_attr.in_filters(self.condition_attr)
        for column, value in criterion:
    ...
    def gte_filter(self):
        criterion = self.entity_attr.gte_filters(self.condition_attr)
        for column, value in criterion:
    ...
    def lte_filter(self):
        criterion = self.entity_attr.lte_filters(self.condition_attr)
        for column, value in criterion:
            if value is not None:
    ...
    def date_filter(self):
        criterion = self.entity_attr.date_filters(self.condition_attr)
        for column, value in criterion:
