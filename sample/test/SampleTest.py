...
class SampleTest(unittest.TestCase):
    ...
    def test_select(self):
        criterion = SampleCriterion(col_var='n', col_text_in=['m'], col_tinyint_gte=3, col_int_lte=9, col_double=6.5,
    ...
    def test_insert(self):
        ...
        sample = SampleCriterion(col_var='i', col_text='6', col_tinyint=1, col_int=5, col_double=3.5, col_datetime=now)
    ...
    def test_update(self):
        criterion = SampleCriterion(id_in=[13, 15])
        sample = SampleCriterion(col_var='n', col_text='m', col_tinyint=3, col_int=9, col_double=6.5,
    ...
    def test_delete(self):
        criterion = SampleCriterion(id_in=[7])
